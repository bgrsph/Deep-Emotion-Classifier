...
class Form(QDialog):
    ...
    def testDataButtonPressed(self):
        ...
        args["test_data_path"] = QFileDialog.getExistingDirectory(self, 'Select directory')
    ...
    def trainDataButtonPressed(self):
        ...
        args["train_data_path"] = QFileDialog.getExistingDirectory(self, 'Select directory')
    ...
    def validationDataButtonPressed(self):
        ...
        args["validation_data_path"] = QFileDialog.getExistingDirectory(self, 'Select directory')
